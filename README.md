<p align="center">
  <img src="https://raw.githubusercontent.com/Funora-Develop/.github/main/assets/funora-java.svg" width="76" height="76" alt="">
</p>

<h1 align="center">Funora для Java</h1>

<p align="center"><em>Java SDK.</em></p>

<p align="center">
  <img alt="status" src="https://img.shields.io/badge/status-planned-9AA3AB?style=flat-square">
  <img alt="maven central" src="https://img.shields.io/badge/maven%20central-namespace%20verified-3B6FA0?style=flat-square">
...
Начинается после того, как реализации на Python и TypeScript сойдутся. Его задача — доказать, что API не заточен под Python: особое внимание отмене операций, builder-ам, неизменяемым моделям и ошибкам.
