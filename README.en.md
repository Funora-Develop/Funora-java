...
Starts after the Python and TypeScript implementations agree. Its job is to prove the API is not Python-shaped: cancellation, builders, immutable models and errors get particular attention here.
